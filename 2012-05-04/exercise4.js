...
var controls0 = [[-0.4,4,0],[-0.4,2.25,1.5],[-0.4,-6,0],[-0.4,2.25,-1.5],[-0.4,4,0]];
var c0 = BEZIER(S0)(controls0);
var curve0 = MAP(c0)(domain1);

var controls1 = [[0,2.7,0],[0,1.35,0.7],[0,-3,0],[0,1.3,-0.7],[0,2.7,0]];
...
var domain2 = DOMAIN([[0,1],[0,1]])([40,80]);
...
var w1 = T([0,1,2])([1.5,-0.25,0.4])(R([0,1])(-PI/2)(R([0,2])([-PI/2])(Wing())));
var w2 = S([2])([-1])(w1);
